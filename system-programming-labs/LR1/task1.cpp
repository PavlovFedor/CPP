...
void printDriveType(const std::string& drive) {
	...
	case DRIVE_UNKNOWN:		std::cout << "unknown type..."; break;//не известный тип
	case DRIVE_NO_ROOT_DIR: std::cout << "wrong dir..."; break;//не правильный путь
	case DRIVE_REMOVABLE:	std::cout << "this drive is REMOVABLE"; break;//съёмный диск
	case DRIVE_FIXED:		std::cout << "this drive is FIXED"; break;//фиксированный диск
	case DRIVE_REMOTE:		std::cout << "this drive is REMOTE/NETWORK drive"; break;//удалённый диск
	case DRIVE_CDROM:		std::cout << "this drive is CD-ROOM drive"; break;//CD-ROM диск
	case DRIVE_RAMDISK:		std::cout << "this drive is RAM drive"; break;//RAM диск
	default: std::cout << "\nUNKNOWN ERROR...\n";
	}
	std::cout << "\n";
}
